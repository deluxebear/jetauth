...
export default function KeyListPage() {
  ...
  const prefs = useTablePrefs({ persistKey: "list:keys" });
  const bulkDelete = useBulkDelete<Key>(KeyBackend.deleteKey, list.refetch);
  ...
  const columns: Column<Key>[] = [
    ...
    { key: "type", title: t("col.type"), sortable: true, filterable: true, width: "120px" },
    {
      key: "accessKey",
      title: t("keys.field.accessKey"),
      sortable: true,
      filterable: true,
      width: "150px",
    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[13px] text-text-muted mt-0.5">{t("keys.subtitle")}</p>
        </div>
