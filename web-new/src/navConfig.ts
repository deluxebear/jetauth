...
export const navGroups: NavGroupDef[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/invitations", labelKey: "nav.invitations", iconName: "TicketCheck" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/adapters", labelKey: "nav.adapters", iconName: "Cable" },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/entries", labelKey: "nav.entries", iconName: "DoorOpen" },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/tokens", labelKey: "nav.tokens", iconName: "KeySquare" },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/orders", labelKey: "nav.orders", iconName: "ClipboardList" },
      ...
      { to: "/subscriptions", labelKey: "nav.subscriptions", iconName: "Repeat" },
