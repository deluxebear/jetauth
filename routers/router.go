...
func InitAPI() {
	...
	web.Router("/api/biz-activate-authorization-model", &controllers.ApiController{}, "POST:BizActivateAuthorizationModel")
	...
	web.Router("/api/biz-rebac-stats", &controllers.ApiController{}, "GET:BizGetReBACStats")
	web.Router("/api/biz-list-assertions", &controllers.ApiController{}, "GET:BizListAssertions")
	...
	web.Router("/api/get-http-email-presets", &controllers.ApiController{}, "GET:GetHttpEmailPresets")
