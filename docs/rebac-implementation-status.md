...
| SLA 基线文档(目标 p99 Check<50ms、List<300ms)| ⚠️ 已实测:Check ✅ 95µs mean、ListObjects ❌ 801ms mean(2.7× 超标)| `docs/rebac-sla-baseline.md` §Blockers B1 — 发 release tag 前必须完成 ListObjects 并发/短路/反向索引优化 |
