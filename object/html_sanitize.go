...
// htmlSanitizer is the shared policy used to scrub the four admin-editable
// HTML fields on Application (headerHtml / footerHtml / signinHtml /
// signupHtml) before they're persisted. Paired with the frontend DOMPurify
// policy in web-new/src/auth/shell/SafeHtml.tsx — defense in depth: admins
// may paste raw HTML, we strip dangerous constructs both on save and on
// render.
...
// sanitizeApplicationHtml scrubs the four HTML fields in place. Safe to
